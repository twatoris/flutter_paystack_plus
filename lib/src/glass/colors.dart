...
Color shadowColorGlobal = Colors.grey.withAlpha((0.4 * 255).round());
...
/// Creates a MaterialColor from a Color, generating a swatch of shades.
...
MaterialColor createMaterialColor(Color color) {
  ...
  // Extract components without using deprecated properties
  final int colorValue = color.hashCode & 0xFFFFFFFF;
